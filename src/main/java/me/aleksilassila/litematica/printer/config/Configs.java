...
public class Configs {
    ...
    public static final ConfigInteger BLOCKS_PER_TICK = new ConfigInteger("blocksPerTick", 1, 1, 50).apply(GENERIC_KEY);
    public static final ConfigBoolean RESTRICT_ROTATION = new ConfigBoolean("restrictRotation", false).apply(GENERIC_KEY);
